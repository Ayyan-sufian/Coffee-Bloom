...
import 'package:coffee_bloom/view/coffee_main_screen.dart';
...
class CategoryIdScreen extends StatefulWidget {
  ...
  const CategoryIdScreen({super.key, required this.cateName, required this.id});
...
class _CategoryIdScreenState extends State<CategoryIdScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (token != null) {
        await context.read<CategoryViewModel>().fetchCategoryId(
          token,
          widget.id,
        );
      }
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Padding(
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                final id = item.coffeeId;
                                if (id != null) {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => CoffeeMainScreen(id: id.toString(),),
                                    ),
                                  );
                                }
                              },
